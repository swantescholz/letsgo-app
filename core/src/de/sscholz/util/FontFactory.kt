...
object FontFactory {
    ...
    val Default by lazy { MyFont("OpenSans-Regular.ttf") }
    val Light by lazy { MyFont("OpenSans-Light.ttf") }
    val Bold by lazy { MyFont("OpenSans-Bold.ttf") }
    val Decorative by lazy { MyFont("decorative.ttf") }
